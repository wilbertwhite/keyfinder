...
<body>
	<div class=container>
		...
		<form method="post">
			...
			<input class="btn8" type="submit" name="button8" value="Button8" />
			<!---Speaker on top bookshelf--->
			<input class="btn9" type="submit" name="button9" value="Button9" />
			<!---coffe mug far left--->
			<input class="btn10" type="submit" name="button10" value="Button10" />
	...
	<div>
		...
		if ($_SESSION['ongoing'] == false) {
			if (isset($_SESSION['time'])) {
				...
				echo "<div class=leftsidepadding>See your score on the <a href='leaderboardhard.php'>Leaderboard</a>!</div>";
			}
		}
		?>
	</div>
